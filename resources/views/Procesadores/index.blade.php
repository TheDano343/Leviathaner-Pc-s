        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-header">
                    <h4>
                        Procesador
                        <a class="btn btn-primary float-end" href="{{url('procesador/create')}}">Agregar un
                            procesador</a>
                    </h4>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <form action="{{route('procesador.index')}}" method="GET">
                            <div class="btn-group">
                    ...
                    <table class="table table-responsive table-hover">
                        ...
                        <tr>
                            ...
                            <td>{{$procesador->Estatus->Nombre_Estatus}}</td>

                            <td><img src="{{asset('storage').'/'.$procesador->Portada}}" alt="image"
                            ...
                            <th><a class="btn btn-warning"
                                    href="{{route('procesador.edit', ['procesador'=>$procesador])}}">Editar</a></th>
                            

                            
                            <th>
                                <form action="{{route('procesador.destroy', ['procesador'=>$procesador])}}"
                                    method="post">
                                    @csrf
                                    @method('delete')
                    ...
                    <div>
                        {{ $procesadores->appends(['busqueda'=>$busqueda]) }}
                    </div>
                </div>
            </div>
        </div>
